...
public class NearbyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (request.getParameter("email") != null) {
                ...
                try {
                    ...
                    if (dbCursor.count() == 1 & dbCursor.hasNext()) {
                        ...
                        WithinSiteResults results = model.generateRecommendedNearbyResults(userDBObject);
                        response.getWriter().write(results.toString(4));
            ...
            response.getWriter().write("{\"result\":\"error\", \"message\":\"" + e.getMessage() + "\"}");
        } finally {
            db.requestDone();
        }
